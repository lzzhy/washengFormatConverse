import { useRequestImplement } from "./baseRequest";
import { loadingPlugin } from "./plugins/loadingService";
import { messagePlugin } from "./plugins/messageService";
...
function useRequest<TData = any, TParams = any>(options: Options<TData, TParams>, plugins?: RegisterPlugin[]) {
  return useRequestImplement(options, [...(plugins || []), loadingPlugin, messagePlugin]);
}
